...
if(CC_IS_EMCC)
    ...
    if (BUILD_IS_DEBUG)
        ...
        # Note: --profiling-funcs keeps wasm function names for symbolizing
        # in-browser crashes (RuntimeError stacks only show wasm-function[N]
        # once wasm-opt strips the name section).
        set(EMCC_LINKER_FLAGS "-Os;--profiling-funcs")
    endif()
