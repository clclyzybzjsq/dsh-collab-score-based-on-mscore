...
# Wasm via emsdk on Windows exposes em++ as em++.bat/em++.exe; on POSIX as
# em++. Match any of those (local patch: upstream regex assumed a bare em++)
if(${CMAKE_CXX_COMPILER} MATCHES "/em\\+\\+(-[a-zA-Z0-9.])?(\\.bat|\\.exe)?$")
    set(OS_IS_WASM 1)
