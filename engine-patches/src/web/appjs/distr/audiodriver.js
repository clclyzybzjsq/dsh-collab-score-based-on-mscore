    ...
    var api = {
        ...
        setup: async function(config, rpcPort, audio_context) {
            ...
            try {
                ...
                // Local patch: MuseAudio.js (audioengine wasm) is not part of the
                // main engine build and may be missing; degrade gracefully instead
                // of crashing on processor.port below.
