...
#ifdef NO_QT_SUPPORT
static const std::map<AudioResourceType, String> RESOURCE_TYPE_MAP = {
    { AudioResourceType::Undefined, String::fromAscii("undefined") },
    { AudioResourceType::MuseSamplerSoundPack, String::fromAscii("muse_sampler_sound_pack") },
    { AudioResourceType::FluidSoundfont, String::fromAscii("fluid_soundfont") },
    { AudioResourceType::VstPlugin, String::fromAscii("vst_plugin") },
    { AudioResourceType::MusePlugin, String::fromAscii("muse_plugin") },
};
#else
